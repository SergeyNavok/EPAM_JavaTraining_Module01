...
public class Branching03 {
	...
	public static void main(String[] args) {
		...
		x3 = 4;
		y3 = 8;
		printCheckingCoordinatesDots(x1, y1, x2, y2, x3, y3);
	...
	private static void printCheckingCoordinatesDots(double x1, double y1, double x2, double y2, double x3, double y3) {
		boolean isCorrectCoordinates;

		isCorrectCoordinates = (x3 - x1) / (x2 - x1) == (y3 - y1) / (y2 - y1);
