...
public class Branching03 {
	...
	public static void checkingCoordinatesDots(double x1, double y1, double x2, double y2, double x3, double y3) {
		boolean result;

		result = (x3 - x1) / (x2 - x1) == (y3 - y1) / (y2 - y1);

		System.out.printf("Точки A(%.0f,%.0f), B(%.0f,%.0f), C(%.0f,%.0f): ", x1, y1, x2, y2, x3, y3);
